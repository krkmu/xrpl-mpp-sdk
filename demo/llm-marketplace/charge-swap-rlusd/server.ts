...
async function main() {
  ...
  httpServer.listen(PORT, () => {
    ...
    log.box([
      ...
      '',
      'No issuer, no LP, no AMMCreate, no /faucet here: RLUSD is Ripple-issued',
      'and the XRP/RLUSD pool is public. The marketplace never holds RLUSD',
      'except what the client pays it.',
      '',
